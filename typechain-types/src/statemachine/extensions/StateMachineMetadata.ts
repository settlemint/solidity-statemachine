...
export interface StateMachineMetadataInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
...
export interface StateMachineMetadata extends BaseContract {
  connect(runner?: ContractRunner | null): StateMachineMetadata;
  waitForDeployment(): Promise<this>;

  interface: StateMachineMetadataInterface;
