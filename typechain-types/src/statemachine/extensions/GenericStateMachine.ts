...
export interface GenericStateMachineInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "ROLE_ADMIN"
...
export interface GenericStateMachine extends BaseContract {
  connect(runner?: ContractRunner | null): GenericStateMachine;
  waitForDeployment(): Promise<this>;

  interface: GenericStateMachineInterface;
